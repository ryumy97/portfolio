  ...
  return (
    <SmoothScroll horizontal>
      <main className="flex min-h-svh w-max items-center gap-[10vw] md:gap-[5vw] px-8">
        ...
        >
          <CVDescription>
            Designed, built and launched a web platform featuring a 3D Gaussian
            splat scene editor as well as a published npm package as an
            embeddable viewer library in React. This includes full-stack
            architecture of uploading and transforming 3DGS data to DB and blob
            storage, user authentication, payment integration of a subscription
            model, implementing a cache layer, end-to-end testing and a CI/CD
            pipeline of both the web app and packages.
          </CVDescription>
        ...
        >
          <CVList className="mt-2">
            <CVListItem>
              Personal storage for my photos. Upload and manage folder structure
              and images in the blob storage.
            </CVListItem>
            <CVListItem>Next.js, Drizzle, Cloudflare R2, PostgreSQL</CVListItem>
          </CVList>
        </Section>
        ...
        >
          <CVList className="mt-2">
            <CVListItem>
              Responsible for mostly, but not limited to, frontend development.
              This includes building and leading award-winning works like a
              campaign website, PWA, large content website and product-based web
              application.
            </CVListItem>
            <CVListItem>
              Frontend — Three.js, R3F, Theatre.js, WebGL, Pixi.JS, Playcanvas,
              Spark.js, MediaPipe, D3, Next.js, React, Vue.js, Vite, Shadcn,
              motion (Framer Motion), GSAP, Tailwind CSS, Storybook, PWA.
            </CVListItem>
            <CVListItem>
              Backend — .NET C#, Umbraco CMS, Sanity, Algolia, Drizzle, Prisma,
              PostgreSQL
            </CVListItem>
            <CVListItem>
        ...
        <SubSection>
          ...
          <CVList className="mt-2">
            <PointerEventHandler type="bullet" asChild>
              <Link href="/projects/fola" className="underline text-secondary">
            ...
            <CVSubList>
              <CVListItem>2024 Best Awards Digital Campaigns - Gold</CVListItem>
